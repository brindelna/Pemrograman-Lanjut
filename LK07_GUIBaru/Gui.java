package Praktikum_Pemrograman_Lanjut.LK07_GUIBaru;
...
public class Gui extends JFrame {
    ...
    public static void main(String[] args) {
        DataRepository<Siswa> repository = new SiswaRepository("Praktikum_Pemrograman_Lanjut\\\\LK07_GUIBaru\\\\siswa.csv"); //menggunakan SiswaRepository sebagai implementasi DataRepository, dengan file path "siswa.csv" untuk menyimpan data siswa
